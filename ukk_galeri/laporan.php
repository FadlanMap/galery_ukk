        ...
        <div class="col-md-6 profile-card">
            <div class="row">
                <div class="col-md-4 text-center">
                    <img src="assets/img/fadlan.jpg" class="img-fluid rounded-circle" alt="Gambar Profil">
                </div>
                <div class="col-md-8">
                    <h2>Fadlan M.A Permadi</h2>
                    <h3>XII PPLG 1</h3>
                    <h3>SMKN 4 BOGOR</h3>
                    <p><strong>Email:</strong> fadlanganz854@gmail.com</p>
                    <h3>Media Sosial</h3>
                    <a href="https://www.instagram.com/fdlnnmp?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" class="btn btn-custom mr-2">Instagram</a>
                    <a href="https://www.youtube.com/@fadlanm." class="btn btn-custom">Youtube</a>
                </div>
            </div>
        </div>
    </div>
