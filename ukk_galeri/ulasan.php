...
<div class="container mt-4">
    ...
    <div class="list-group" id="commentList">
        <div class="profile-card show">
            <h5 class="mb-1">Putra Septiadi P</h5>
            <p class="mb-1">Komentar pertama dari Putra. Sangat menarik sekali!</p>
            <small>Waktu: 01 Oktober 2024</small>
        </div>

        <div class="profile-card show">
            <h5 class="mb-1">Adam Ramdani F</h5>
            <p class="mb-1">Komentar kedua dari Adam. Saya setuju.</p>
